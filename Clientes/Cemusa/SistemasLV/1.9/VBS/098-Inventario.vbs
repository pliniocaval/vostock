...
Set colInstances = objWMIService.ExecQuery( "SELECT * FROM MS_SystemInformation" )
...
SystemFamily = objInstance.SystemFamily
SystemManufacturer = objInstance.SystemManufacturer
SystemProductName = objInstance.SystemProductName
SystemSKU = objInstance.SystemSKU
Next
...
strLogFile.WriteLine "SystemFamily: " & CheckNull(SystemFamily)
strLogFile.WriteLine "SystemManufacturer: " & CheckNull(SystemManufacturer)
strLogFile.WriteLine "SystemProductName: " & CheckNull(SystemProductName)
strLogFile.WriteLine "SystemSKU: " & CheckNull(SystemSKU)

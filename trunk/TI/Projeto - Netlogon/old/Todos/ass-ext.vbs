...
With objSelection
  ...
  End With
    .Font.Italic = False
    .TypeText strAddress & Chr(11) & strl & " - " & strco & Chr(11) & "CEP:" & strpostalCode & Chr(11) & "Tel.:" & strPhone & Chr(11) & "Cel.:" & strCel & Chr(11) & "Fax.:" & strFax & Chr(11) & "Email:"& strMail & Chr(11) & "Site:" & strWeb & Chr(11)
    .TypeText Chr(11)
